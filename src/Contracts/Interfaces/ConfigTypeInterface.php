...
interface ConfigTypeInterface {
     ...
     *
     * @param array<string, mixed> $data Die rohen Konfigurationsdaten.
     * @return array<string, mixed> Die geparsten Konfigurationsdaten.
     */
     ...
     *
     * @param array<string, mixed> $data Die zu prüfenden Konfigurationsdaten.
     ...
     *
     * @param array<string, mixed> $data Die zu validierenden Konfigurationsdaten.
     * @return list<string> Liste der Validierungsfehler (leer wenn keine Fehler).
     */
